...
void PostEffectComponent::DrawObject() {
	...
	// ブレンドステートの設定
	//PostEffect::ShimmerPostEffect::Instance()->SetBlendState();
	...
	auto _dsv = CDirectXGraphics::GetInstance()->GetDepthStencilView();
	this->m_devContext->OMSetRenderTargets(1, &_rtv, _dsv);
}
