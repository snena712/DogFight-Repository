...
void QuadRender::DrawObject() {
	...
	/*	if (tra != nullptr) {
		...
		if (renderMode == Quad::RenderMode::BILLBOARD) {
			DirectX::XMFLOAT4X4 cameramat = Component::Camera::GetMainCamera()->GetCameraMatrix();

			make._11 = cameramat._11;
			make._12 = cameramat._21;
			make._13 = cameramat._31;

			make._21 = cameramat._12;
			make._22 = cameramat._22;
			make._23 = cameramat._32;
			
			make._31 = cameramat._13;
			make._32 = cameramat._23;
			make._33 = cameramat._33;
		...
		MyQuad::DrawQuad(MyQuad::RenderMode::Rendr3D,MyQuad::RenderState::Basic3D, uv, width, height, color, make, texFileName);
	}
}
