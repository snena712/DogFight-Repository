...
#include "../source/Compute/ComputeDateHeader.h"
...
namespace Component {
	...
	public:
		...
		void SetEndColor(XMFLOAT4 _col) { plusData->color.endColor = _col; }
