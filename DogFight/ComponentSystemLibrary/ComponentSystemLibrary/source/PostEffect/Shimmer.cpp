...
void Shimmer::State()
{
	poslist[0] = player->transform->position - player->transform->forward() * 10 - player->transform->right() * 2.5f;
	poslist[1] = player->transform->position - player->transform->forward() * 10 + player->transform->right() * 2.5f;
