#pragma once
#include "Map1_3Class.h"
#include "../MainSceneHeader.h"

void Map1_3Class::InitScene() {
	...
	pos.emplace_back();
	pos[7] = new Vector3(-150, 150, 200);
	pos.emplace_back();
	pos[8] = new Vector3(-250, 150, 300);
	pos.emplace_back();
	pos[9] = new Vector3(-50, -50, -100);
	//pos.emplace_back();
	//pos[10] = new Vector3(-50, 50, 100);
