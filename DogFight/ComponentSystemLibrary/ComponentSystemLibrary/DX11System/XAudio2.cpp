...
{
	{"assets/Sound/BGM/battle2.wav", true},			// サンプルBGM（ループさせるのでtrue設定）
	{"assets/Sound/BGM/ocr_eiji.wav", true},		// サンプルBGM（ループさせるのでtrue設定） 1
	{"assets/Sound/SE/Bullet_trance.wav",false},	// サンプルSE（ループしないのでfalse設定） 2
	{"assets/Sound/SE/Bullet_trance.wav",false},	// サンプルSE（ループしないのでfalse設定） 3
	{"assets/Sound/SE/SE_HOMING.wav",false},		// サンプルSE（ループしないのでfalse設定） 4
	{"assets/Sound/SE/SE_HOMING.wav",false},		// サンプルSE（ループしないのでfalse設定） 5
	{"assets/Sound/SE/SE_LOCKON01.wav",false},		// サンプルSE（ループしないのでfalse設定） 6
	{"assets/Sound/SE/SE_LOCKON02.wav",false},		// サンプルSE（ループしないのでfalse設定） 7
	{"assets/Sound/SE/SE_OK.wav",false},			// サンプルSE（ループしないのでfalse設定） 8
	{"assets/Sound/SE/SE_MOVE.wav",false},			// サンプルSE（ループしないのでfalse設定） 9
};
